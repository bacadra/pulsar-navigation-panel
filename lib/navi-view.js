...
class TreeView {
  ...
  render() {
    if (this.item.naviClass==='technical' && atom.config.get('navigation-panel.general.hideTechnicals')) {
      return <div />
    } else if (this.item.naviClass==='important' && atom.config.get('navigation-panel.general.hideImportants')) {
      return <div />
    }
