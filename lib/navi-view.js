...
export class NavigationView {
  ...
  constructor() {
    ...
    STATES.textWrap     = atom.config.get('navigation-panel.categories.textWrap' )
  ...
  render() {
    ...
    if (!this.headers) {
      ...
      naviList = <div class="navigation-list" id='navigation-list' style={`white-space:${wspace};display:${STATES.viewMode};`}>{this.headers.map( (item) => { return <TreeView {...item}/> })}</div>
    } else {
      naviList = <div class="navigation-list" id='navigation-list'>
