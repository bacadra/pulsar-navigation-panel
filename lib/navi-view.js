...
class TreeView {
  ...
  render() {
    if (this.item.classList.includes('info') && atom.config.get('navigation-panel.hide.info')) {
      return <div />
    } else if (this.item.classList.includes('success') && atom.config.get('navigation-panel.hide.success')) {
      return <div />
    } else if (this.item.classList.includes('warning') && atom.config.get('navigation-panel.hide.warning')) {
      return <div />
    } else if (this.item.classList.includes('error') && atom.config.get('navigation-panel.hide.error')) {
      return <div />
    }
