...
class DocumentOutlineView {
  ...
  constructor() {
    ...
    this.autoScroll = atom.config.get("navigation-pane.autoScrollOutline");
    this.doHighlight = atom.config.get("navigation-pane.highlightCurrentSection");
    etch.initialize(this);
  }

  getDefaultLocation() {
    return atom.config.get('navigation-pane.defaultSide');
  }
  ...
  render() {
    this.outlineElements = this.outline.map(tree => {
      ...
      tree.autoCollapse = atom.config.get('navigation-pane.collapseByDefault');
