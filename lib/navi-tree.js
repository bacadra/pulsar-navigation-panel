...
export class NavigationTree {
  ...
  constructor() {
    ...
    this.disposables.add(
      ...
      atom.config.observe('navigation-panel.general.scrollAnimation', {}, (value) => {
        STATES.scrollAnimation = value
      }),
    ...
    this.disposables.add(this.refs.searchEditor.onDidChange(() => { this.filterQuery() }))
  }
  ...
  scrollToElement(element) {
    return compute(element, {
      ...
      if (el.id==='navigation-list') { el.scrollTo({ top:top, behavior:'smooth' }) }
    })
  }
...
class TreeView {
  ...
  scrollToLine(e) {
    if (this.item.viewer) {
      ...
      if (STATES.scrollAnimation && this.item.editor.getElement().scrollAnimation) {
