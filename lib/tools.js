 ...
 */
export function * depthTreeIter(item) {
...
export function scopeIncludesOne(scopeDescriptor, scopeList) {
...
export function scopeIn(scope, scopeList) {
...
export function scopeEqual(scopeOne, scopeTwo) {
...
export function scopeContainsOne(scope, scopeList) {
  for (let matchScope of scopeList) {
...
export function scopeContains(outerScope, innerScope) {
