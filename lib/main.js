...
import { ScannerTasklist     } from './scanners/tasklist'
    ...
    general: {
      ...
      properties: {
        ...
        animationThreshold: {
          ...
          description: 'After tree click the editor scroll with animation of [smooth-scroll](https://github.com/bacadra/pulsar-smooth-scroll) if distance between screen position and header is below the limit',
          type: 'integer',
          minimum: 0,
          default: 250,
        },
