    ...
    this.disposables.add(
      atom.commands.add('atom-workspace', {
        ...
        'navigation-panel:markers-toggle': () => {
          atom.config.set('navigation-panel.general.markLines', !atom.config.get('navigation-panel.general.markLines'))
        },
        'navigation-panel:search-bar-toggle': () => {
          atom.config.set('navigation-panel.general.searchBar', !atom.config.get('navigation-panel.general.searchBar'))
        },
        'navigation-panel:category-bar-toggle': () => {
          atom.config.set('navigation-panel.general.categoryBar', !atom.config.get('navigation-panel.general.categoryBar'))
        },
      }),
