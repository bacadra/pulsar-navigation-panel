  ...
  activate() {
    ...
    this.disposables.add(
      atom.commands.add('atom-workspace', {
        ...
        'navigation-panel:fold-all-info'    : () => this.foldAsTable('info'),
        'navigation-panel:fold-all-success' : () => this.foldAsTable('success'),
        'navigation-panel:fold-all-warning' : () => this.foldAsTable('warning'),
        'navigation-panel:fold-all-error'   : () => this.foldAsTable('error'),
