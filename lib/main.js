  ...
  config: {
    general: {
      ...
      properties: {
        ...
        scrollAnimation: {
          order: 11,
          title: 'Use scroll animation',
          description: 'After tree click scroll the editor with animation of [smooth-scroll](https://github.com/bacadra/pulsar-smooth-scroll)',
          type: 'boolean',
          default: true,
        },
        traceVisible: {
    ...
    tasklist: {
      ...
      properties: {
        useHeaders: {
          title: "Use Header in navigation-list",
